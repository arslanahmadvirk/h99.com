...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className="hidden md:flex md:flex-row bg-gray-800 mt-12 mb-10 flex-wrap items-center justify-between md:w-60 z-10 rounded-2xl shadow dark:border dark:border-gray-700 ">
