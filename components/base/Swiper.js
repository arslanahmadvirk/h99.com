...
function SwiperComponent({
  ...
  return (
    <SwiperComponentWrapper modules={[Grid, A11y]} {...props} style={{ height: scwHeight }}>
      {isOneInTwoGrid && (
        <SwiperSlide>
          <div
          ...
          >
            <img src="/" className="bgame__item__img" width="100%" height="100%" alt="" />
            ...
            <Link href="/">
              <a className="bgame__item__mask">
                <div className="bgame__item__play-icon">
                  <div className="icon iconfont" style={{ fontSize: 48, gridGap: 8, gap: 8 }}>
      ...
      {data.map((item) => (
        <SwiperSlide key={item.id}>
          <div
            className={`${isOneInTwoGrid ? 'bgame__item is--wider' : 'bgame__item'}`}
            style={{
              paddingBottom: `${bgiHeight}%`,
