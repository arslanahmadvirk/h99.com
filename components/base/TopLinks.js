  ...
  return (
    <div className="flex mx-auto w-4/5 py-3">
      ...
      {!show ? (
        ...
        <>
          ...
          <div
            ...
            class="z-10 w-30 bg-white rounded divide-y divide-gray-100 shadow
         dark:bg-gray-700 language-switch"
      ...
      <div
        ...
        tabindex="-1"
        aria-hidden="true"
        className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center backdrop-blur-lg"
      >
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleRegData("email", e.target.value)}
                      required
                    />
                  </div>
                  <div className="flex flex-row space-x-4">
                  ...
                  <div className="flex flex-row space-x-4">
                    ...
                    <div className="w-1/2">
                      ...
                      <input
                        ...
                        className=" border   sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                        onChange={(e) =>
                          handleRegData("password_confirmation", e.target.value)
                        }
                        required
                      />
                    </div>
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input
                        ...
                        value="yes"
                        className="w-4 h-4 border  rounded  focus:ring-3 focus:ring-primary-300 bg-gray-700 border-gray-600 focus:ring-primary-600 ring-offset-gray-800"
                        onChange={(e) => handleRegData("agree", e.target.value)}
                        required
                      />
                    </div>
                    <div className="ml-3 text-sm">
