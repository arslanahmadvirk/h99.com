...
const TopLinkWrapper = styled(Box)(() => ({
  width: '100%',
  display: 'flex',
  alignItems: 'center',
...
function TopLinks() {
  return (
    <TopLinkWrapper>
      ...
      <button type="button" class="text-black bg-white hover:bg-white focus:outline-none focus:ring-4 focus:ring-white font-medium rounded-full text-sm px-7 py-2 text-center mr-2 mb-2 dark:focus:ring-white">Login</button>
      </Link>
      <Link href="/signup" passHref>
      <button type="button" class="text-black bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-7 py-2 text-center mr-2 mb-2 dark:focus:ring-yellow-900">SignUp</button>
      </Link>
