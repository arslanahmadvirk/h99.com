      ...
      <Box component="section" id="banners" sx={{ pt: 3 }}>
        <Container maxWidth="xl">
          <Box
            display="grid"
            gap="16px"
            sx={{ gridTemplateRows: '150px 150px', gridTemplateColumns: '544px 1fr 464px' }}
          >
            ...
            >
              <Typography component="h2" color="primary.light" fontWeight={900}>
                SWAP
              </Typography>
              ...
              <div className="price">
                <Typography component="p" variant="body2" color="primary.light" fontWeight={400}>
                  Current:
                </Typography>
                <Typography component="span" variant="body2" color="primary.light" fontWeight={900}>
                  $0.0123
                </Typography>
              </div>
            </ActivityItem>
            ...
            <ActivityItem
              ...
              buttonText="Details"
            >
              <Typography component="h2" color="primary.light" fontWeight={600}>
                J9BC Loan
              </Typography>
              <Typography component="p" variant="body1" color="primary.light" fontWeight={400}>
      ...
      <Box component="section" id="events">
        <Container maxWidth="xl">
          <Box
            ...
            sx={{
              marginTop: '64px',
              gridTemplateColumns: '1008px 1fr',
            }}
          >
            <EventCard />
            <EventItem
